	...
	return typeof tag === 'string'
		...
		: typeof tag.color !== 'string'
			...
			: {
					...
					color: getA11yColorMatch(tag.color)[1],
				}
}
...
export const getCategoryStyles = (category: string) => {
	const categoryMap: Record<string, { color: string; icon: React.ReactNode }> = {
		'Animal Welfare': {
			color: 'bg-rose-50/80 text-rose-700 hover:bg-rose-100/80 active:bg-rose-100/80 border-rose-200/50',
		...
		'Child Welfare': {
			color: 'bg-purple-50/80 border-purple-200/50 text-purple-700 hover:bg-purple-200/80 active:bg-purple-200/80',
		...
		'Environmental Protection': {
			color: 'bg-green-50/80 text-green-700 hover:bg-green-100/80 active:bg-green-100/80 border-green-200/50',
		...
		'Culture and Arts': {
			color: 'bg-blue-50/80 text-blue-700 hover:bg-blue-100/80 active:bg-blue-100/80 border-blue-200/50',
			icon: <MessageSquare className="w-4 h-4" />,
		},
		'Access to Clean Water': {
			color: 'bg-cyan-50/80 border-cyan-200/50 text-cyan-700 hover:bg-cyan-200/80 active:bg-cyan-200/80',
			icon: <Droplets className="w-4 h-4" />,
		},
		Education: {
			color: 'bg-indigo-50/80 text-indigo-700 hover:bg-indigo-100/80 active:bg-indigo-100/80 border-indigo-200/50',
		...
		'Community News Initiatives': {
			color: 'bg-slate-50/80 text-slate-700 hover:bg-slate-100/80 active:bg-slate-100/80 border-slate-200/50',
			icon: <Newspaper className="w-4 h-4" />,
		},
		'Food Campaigns': {
			color: 'bg-orange-50/80 border-orange-200/50 text-orange-700 hover:bg-orange-200/80 active:bg-orange-200/80',
			icon: <UtensilsCrossed className="w-4 h-4" />,
		},
		'Empowering Communities': {
			color: 'bg-teal-50/80 text-teal-700 hover:bg-teal-100/80 active:bg-teal-100/80 border-teal-200/50',
			icon: <Rocket className="w-4 h-4" />,
		},
		'Sustainable Agriculture': {
			color: 'bg-sky-50/80 border-emerald-200/50 text-emerald-700 hover:bg-emerald-200/80 active:bg-emerald-200/80',
